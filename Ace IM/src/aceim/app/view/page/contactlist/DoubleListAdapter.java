...
public class DoubleListAdapter extends ContactListAdapter {
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		...
		GridView view = getGroupContentView(convertView, parent, spacingDp, g);		
	...
	protected GridView getGroupContentView(View convertView, View parent, int spacingDp, BuddyGroup g) {
		GridView view;
		if (convertView == null) {
		...
		if (view.getTag() == null || view.getTag() != g) {
			view.setAdapter(new GroupItemsAdapter((MainActivity) parent.getContext(), R.layout.contact_list_plain_item, R.id.username, g.getBuddyList(), mResources));
			view.setTag(g);
		} else {
